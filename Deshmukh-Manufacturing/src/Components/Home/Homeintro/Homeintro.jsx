...
function Homeintro() {
  return (
    <>
      ...
      <p className="absolute text-white top-52 left-1/4 text-9xl sm:text-2xl xs:text-xl xs:left-8 xs:top-64" data-aos="zoom-in">
        Welcome To
      </p>
      <h1 className=" absolute text-white top-72 left-1/4  font-bold xs:text-4xl xs:left-8 font-serif xs:top-80 text-6xl " id="title-name">
        <span> D</span>
      ...
      <button className="absolute top-96 px-6 py-2 left-1/2 xs:top-88 text-white xs:left-1/3">
