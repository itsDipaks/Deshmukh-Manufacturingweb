  ...
  return (
    <div className="relative ">
      <section class="text-gray-600 body-font xs:mt-6"  >
        <div class=" px-5 py-2 mx-auto xs:px-3">
          <div class="flex flex-col text-center w-full mb-10 ">
            {/* <h2 class="text-xs text-black tracking-widest font-medium title-font mb-1">
              MANUFACTURING
            </h2> */}
            <h1 class="xs:text-xl sm:text-xl text-3xl font-medium title-font mb-4  text-gray-900">
              Welcome To{" "}
            ...
            <p class="lg:w-2/3 xs:w-full mx-auto leading-relaxed text-base xs:text-sm" >
              <span className="text-red-400"> DESHMUKH MANUFACTURING PRIVATE LIMITED.(DMPL),</span>{" "}
