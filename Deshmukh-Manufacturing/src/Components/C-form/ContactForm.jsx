...
console.log(done)
  ...
  <div className=" px-4 xs:px-2 py-8 mx-auto ">
    <div className="flex flex-col text-center w-full mb-12">
      <h1 className="sm:text-3xl xs:text-2xl text-2xl font-medium title-font mb-4 xs:mb-1 text-black">FEEL FREE TO ENQUIRY</h1>
      {/* <span className="inline-block h-1 w-32 xs:w-24  rounded bg-red-500  xs:ml-28 mb-8 text-center"></span> */}
      {/* <p className=" lg:w-2/3 mx-auto leading-relaxed text-base">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify.</p> */}
    </div>
    <div className="lg:w-1/2 md:w-2/3 mx-auto bg-gray-200 p-14 xs:p-4">
      <form ref={form} onSubmit={sendEmail}>
      <div className="flex flex-wrap -m-2">
        <div className="p-2 w-1/2">
          <div className="relative">
            <label for="name" className="leading-7 text-sm text-red-400 font-bold">Name</label>
        ...
        <div className="p-2 w-1/2">
          <div className="relative">
            <label for="email" className="leading-7 text-sm text-red-400 font-bold">Email</label>
        ...
        <div className="p-2 w-full">
          <div className="relative">
            <label for="email" className="leading-7 text-sm text-red-400 font-bold">Subject</label>
        ...
        <div className="p-2 w-full">
          <div className="relative">
            <label for="message" className="leading-7 text-sm text-red-400 font-bold">Message</label>
        ...
        <div className="p-2 w-full">
          <button className="flex mx-auto text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" type='submit'>Send</button>
        </div>
      /
      </div>
      </form>
