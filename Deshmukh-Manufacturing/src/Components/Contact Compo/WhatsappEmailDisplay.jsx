...
const WhatsappEmailDisplay = () => {
  return (
    <div className="flex justfiy-between w-3/5 gap-x-2.5 xs:w-11/12  m-auto   justify-between" data-aos="fade-up">
      ...
      <div className="flex w-2/5 xs:w-1/2 items-center rounded-xl border xs:p-1 truncate xs:text-sm p-4" data-aos="fade-up">
