...
const Footer = () => {
  ...
  <div className=" px-5 py-4 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap xs:w-full xs:px-0 flex-col">
    ...
    <h2 className="title-font font text-red-400 tracking-widest text-lg mb-3  xs:ml-28 font-bold decoration-solid">CONTACT DETAILS</h2>
    <div className="list-none mb-4 border-1 w-full xs:w-full  ">
          <li className="list-none m-1  " >
           <Link to="/"><p className='flex items-cente xs:w-full xs:pl-12 '><MdLocationOn className='text-red-400 w-8 h-8  '/><span className=' ml-4'> K-5, MIDC, Sinnar, Dist.Nashik  -(422113) Maharashtra</span></p>  </Link>
          </li>
          <li className="list-none m-1" >
    ...
    <div className="flex-grow flex flex-wrap justify-between md:pl-20 mb-1 md:mt-0 mt-10 xs:mt-2 md:text-center text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4 ">
        <h2 className="title-font font-bold   text-red-400 tracking-widest text-lg mb-3  decoration-solid font-bold ">QUICK LINKS</h2>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4 ">
        <h2 className="title-font font-medium text-red-400 tracking-widest text-lg mb-3  decoration-solid font-bold">PRODUCTS</h2>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 className="title-font font-medium  text-red-400 tracking-widest text-lg mb-3  decoration-solid font-bold">CONTACT US ON</h2>
        <div className=" mb-5 flex xs:w-11/12 xs:m-auto justify-between mt-14">
          <a href=""> <MdEmail className='h-8  w-full'/></a>
          <a href="https://wa.me/918180060462"> <IoLogoWhatsapp className='h-8  w-full'/></a>
          <a href="tel:+918180060462">  <MdCall className='h-8  w-full'/></a>
